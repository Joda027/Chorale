...
create table public.infos_publiques (
...
-- Ouvre l'accès en lecture (photos, musiques, partitions non protégées)
-- aux visiteurs non connectés, en plus des membres.
...
grant select on public.partitions_publiques to anon;
